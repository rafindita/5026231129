...
@section('eas_content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4><strong>Tambah Karyawan Baru</strong></h4>
    ...
    <form action="{{ route('eas.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea name="pangkat" class="form-control" style="height:100px" placeholder="Pangkat"></textarea>
        </div>
        <div class="form-group">
            <label for="gaji">Gaji:</label>
            <input type="number" step="0.01" name="gaji" class="form-control" placeholder="Gaji" required>
        </div>
