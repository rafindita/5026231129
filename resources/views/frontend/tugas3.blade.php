...
function getEquipmentRented() {
    ...
    return [
        [
            "image" => "img/materialC/Canon EOS 4000D.png",
        ...
        [
            "image" => "img/materialC/Sony Maximum.png",
            "name" => "Sony Maximum",
            "status" => "red",
            "message" => "Dipinjam, kembali pada 18/12/24"
        ]
...
function getEquipmentPending() {
    ...
    return [
        [
            "image" => "img/materialC/NIKON D7500.png",
            "name" => "Nikon D7500",
            "status" => "green",
            "message" => "Diajukan pada 2/12/24"
        ],
        [
            "image" => "img/materialC/Canon Lens EFS 18-135mm.png",
            "name" => "Canon Lens EFS 18-135mm",
            "status" => "green",
            "message" => "Diajukan pada 2/12/24"
        ],
        [
            "image" => "img/materialC/Sony PXW-Z90T XDCAM camcorder.png",
        ...
        [
            "image" => "img/materialC/insta mini11.png",
            "name" => "Instax mini11",
            "status" => "green",
            "message" => "Diajukan pada 2/12/24"
        ],
        [
            "image" => "img/materialC/instax slim-go.png",
            "name" => "Instax slim-go",
            "status" => "green",
            "message" => "Diajukan pada 2/12/24"
        ],
        [
            "image" => "img/materialC/Canon EOS 80D.png",
            "name" => "Canon EOS 80D",
            "status" => "green",
            "message" => "Diajukan pada 2/12/24"
        ],
        [
            "image" => "img/materialC/Sony Zeiss.png",
            "name" => "Sony Zeiss",
            "status" => "green",
            "message" => "Diajukan pada 2/12/24"
        ]
...
<body>
    <div class="status-bar">
        ...
        <div class="status-icons">
            <span class="img-fluid">
                <img src="{{ asset('img/materialC/icons8-signal-24.png') }}" alt="Signal">
            </span>
            <span class="img-fluid">
                <img src="{{ asset('img/materialC/icons8-wi-fi-24.png') }}"alt="WiFi">
            </span>
            <span class="battery-icon">
                <img src="{{ asset('img/materialC/icons8-full-battery-30.png') }}" alt="Battery">
            </span>
        </div>
    </div>
    ...
    <div class="logo-container">
        <div class="logo">
            <img src="{{ asset('img/materialC/Logo CekDong 1.png') }}" alt="CekDong Logo">
        </div>
    </div>
    ...
    <div class="container px-2">
        ...
        <div class="equipment-container">
            ...
            <div class="equipment-card">
                <img src="{{ asset($equipment['image']) }}" alt="<?php echo htmlspecialchars($equipment['name']); ?>" class="equipment-image">
